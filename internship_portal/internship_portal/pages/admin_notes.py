"""Admin Notes page for InternPortal."""
import reflex as rx
...
def admin_notes() -> rx.Component:
            ...
            rx.vstack(
                rx.hstack(
                    rx.vstack(
                        ...
                        rx.text(
                            f"Internship: {item.get('internship_name', 'N/A')} · Posted: {item.get('created_at_display', 'N/A')}",
                            font_size="0.72rem",
    ...
    return rx.box(
        sidebar(active_page="notes", role="admin"),
        rx.box(
                    ...
                    rx.cond(
                        ...
                        rx.center(
                            rx.vstack(
                                ...
                                rx.text("No notes posted yet for this scope.", color=COLORS["on_surface_variant"], font_size="0.9rem"),
